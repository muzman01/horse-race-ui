...
export interface Item {
  item_name: string; // İtem adı
  item_slug: string; // İtem slug
  reputation_points: number; // İtem itibar puanı
  id: any;
}
...
export interface User {
  ...
  game_pass?: number; // Varsayılan olarak sıfır
  reputation_points?: number; // Varsayılan olarak sıfır
  items?: Item[]; // İtemler listesi
}
